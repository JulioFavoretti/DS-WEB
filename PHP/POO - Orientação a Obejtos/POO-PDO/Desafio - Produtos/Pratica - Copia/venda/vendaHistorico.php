    ...
    foreach($vendas as $venda){
        ...
        /* Concatenando a tabala produto com a tabela produtos vendidos, assim teremos todas
         ...
         foreach($prodV as $prods){
            ...
            //Subtotal - calculo para saber o preço total de cada item de acordo com sua quantia.
            $subtotal = $quantidade * $produto['preco'];
            //Preço final pega todos os preços de subtotal
            $precoFinal += $subtotal;
        ...
        //Printa todos os dados coletados acima / Preenchendo a tebela.
        echo "<tr>";
        echo "<td>" . $venda['id'] . "</td>";
